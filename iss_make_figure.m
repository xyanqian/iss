...
% end
if exist([o.OutputDirectory '\background_boundaries.tif'], 'file')==2
    BackgroundImage = imread([o.OutputDirectory '\background_boundaries.tif']);
else
